...
export const createJwt = (userId: string, username: string, email: string, isAdmin: boolean) => jwt.sign({ userId: userId, username: username, email: email, isAdmin: isAdmin }, process.env.JWT_SECRET as string, { expiresIn: "244h" })
